...
{
    public abstract class MagnetWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MagnetWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MagnetWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MagnetDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MagnetDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MagnetDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MagnetDbContext, Task<T>> func)
        {
            T result;
