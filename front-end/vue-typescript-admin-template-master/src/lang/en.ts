export default {
  ...
  login: {
    ...
    Thepasswordcannotbeempty: 'The password can not be empty',
    Thepasswordcannotbelessthan6digits: 'The password can not be less than 6 digits',
    Theconfirmpasswordmustbesameasnewpassword: 'The confirm password must be same as new password',
    changedTenancyName: 'Change Tenancy Name'
  },
  documentation: {
    documentation: 'Documentation',
  ...
  catalog: {
    ...
    delete: 'Delete',
    modify: 'Modify',
    catalogInfo: 'Catalog Infomation',
    name: 'Name',
    id: 'Id',
    type: 'Type',
    sort: 'Sort',
    continueIncrease: 'Continue Increase',
    typeInit: 'Init',
    typeApp: 'App',
    typeQuery: 'Query'
  }
